...
class EnterPinView : PinView {
    override func configureView() {
        super.configureView()
        
        titleLabel.text = "Enter your 6 digit pin"
    }
}


class EnterPin : BaseViewController {
    
    override var contentView: EnterPinView {
        return view as! EnterPinView
    }
...
extension EnterPin : UITextFieldDelegate {
